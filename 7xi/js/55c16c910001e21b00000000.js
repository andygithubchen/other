var Qixi = function() {
    var confi = {
        ...
        audio: {
            ...
            cycleURL: "/public/music/circulation.mp3"
        },
        setTime: {
            walkToThird: 6000,
            walkToMiddle: 6500,
        ...
        snowflakeURl: [
            "/public/images/55adde120001d34e00410041.png",
            "/public/images/55adde2a0001a91d00410041.png",
            "/public/images/55adde5500013b2500400041.png",
            "/public/images/55adde62000161c100410041.png",
            "/public/images/55adde7f0001433000410041.png",
            "/public/images/55addee7000117b500400041.png"]
    };
    var debug = 0;
    if (debug) {
        $.each(confi.setTime,
